...
public class Base_Type extends BaleenAnnotation_Type {
	...
	private final FSGenerator fsGenerator = (addr, cas) -> {
		if (Base_Type.this.useExistingInstance) {
			...
			return new Base(addr, Base_Type.this);
		}
	};
	/** @generated */
	...
	public Base_Type(JCas jcas, Type casType) {
		...
		casFeat_referent = jcas.getRequiredFeatureDE(casType, "referent",
				"uk.gov.dstl.baleen.types.semantic.ReferenceTarget", featOkTst);
		casFeatCode_referent = null == casFeat_referent ? JCas.INVALID_FEATURE_CODE
