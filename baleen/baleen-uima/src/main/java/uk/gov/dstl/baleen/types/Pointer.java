...
public class Pointer extends BaleenAnnotation {
	...
	public BaleenAnnotation getTarget() {
		...
		return (BaleenAnnotation) jcasType.ll_cas
				.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((Pointer_Type) jcasType).casFeatCode_target));
	}
	...
	public void setTarget(BaleenAnnotation v) {
		...
		jcasType.ll_cas.ll_setRefValue(addr, ((Pointer_Type) jcasType).casFeatCode_target,
