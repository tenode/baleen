...
/* First created by JCasGen Mon Mar 14 10:28:13 GMT 2016 */
 ...
 * meaningful than simply the covered text between them Updated by JCasGen Thu Jan 21 13:22:42 GMT
 * 2016
 * 
 * @generated
 */
public class Pattern extends Base {
	...
	public Base getSource() {
		...
		return (Base) jcasType.ll_cas
				.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((Pattern_Type) jcasType).casFeatCode_source));
	}
	...
	public void setSource(Base v) {
		...
		jcasType.ll_cas.ll_setRefValue(addr, ((Pattern_Type) jcasType).casFeatCode_source,
	...
	public Base getTarget() {
		...
		return (Base) jcasType.ll_cas
				.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((Pattern_Type) jcasType).casFeatCode_target));
	}
	...
	public void setTarget(Base v) {
		...
		jcasType.ll_cas.ll_setRefValue(addr, ((Pattern_Type) jcasType).casFeatCode_target,
				jcasType.ll_cas.ll_getFSRef(v));
	}
	...
	public FSArray getWords() {
		...
		return (FSArray) jcasType.ll_cas
				.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((Pattern_Type) jcasType).casFeatCode_words));
	}
	...
	public void setWords(FSArray v) {
		...
		jcasType.ll_cas.ll_setRefValue(addr, ((Pattern_Type) jcasType).casFeatCode_words,
				jcasType.ll_cas.ll_getFSRef(v));
	}
	...
	public WordToken getWords(int i) {
		...
		jcasType.jcas
				.checkArrayBounds(jcasType.ll_cas.ll_getRefValue(addr, ((Pattern_Type) jcasType).casFeatCode_words), i);
		return (WordToken) jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefArrayValue(
