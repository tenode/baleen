...
/* First created by JCasGen Mon Jan 25 09:14:58 GMT 2016 */
 ...
 * working inside annotator) rather than having some specific semantic meaning (eg like reference).
 *
 * @generated
 */
public class Pointer_Type extends BaleenAnnotation_Type {
	...
	/** @generated */
	private final FSGenerator fsGenerator = (addr, cas) -> {
		if (Pointer_Type.this.useExistingInstance) {
			...
			return new Pointer(addr, Pointer_Type.this);
		}
	};
	/** @generated */
	...
	public Pointer_Type(JCas jcas, Type casType) {
		...
		casFeat_target = jcas.getRequiredFeatureDE(casType, "target", "uk.gov.dstl.baleen.types.BaleenAnnotation",
				featOkTst);
		casFeatCode_target = null == casFeat_target ? JCas.INVALID_FEATURE_CODE
				: ((FeatureImpl) casFeat_target).getCode();

		casFeat_targetId = jcas.getRequiredFeatureDE(casType, "targetId", "uima.cas.Long", featOkTst);
		casFeatCode_targetId = null == casFeat_targetId ? JCas.INVALID_FEATURE_CODE
