 ...
 * @generated */
public class ComplexEvent_Type extends Base_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (ComplexEvent_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = ComplexEvent_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new ComplexEvent(addr, ComplexEvent_Type.this);
  			   ComplexEvent_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new ComplexEvent(addr, ComplexEvent_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = ComplexEvent.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("uk.gov.dstl.baleen.types.semantic.ComplexEvent");
  ...
  public int getEventType(int addr) {
      ...
      jcas.throwFeatMissing("eventType", "uk.gov.dstl.baleen.types.semantic.ComplexEvent");
  ...
  public String getValue(int addr) {
      ...
      jcas.throwFeatMissing("value", "uk.gov.dstl.baleen.types.semantic.ComplexEvent");
  ...
  public int getEntities(int addr) {
      ...
      jcas.throwFeatMissing("entities", "uk.gov.dstl.baleen.types.semantic.ComplexEvent");
  ...
  public int getArguments(int addr) {
      ...
      jcas.throwFeatMissing("arguments", "uk.gov.dstl.baleen.types.semantic.ComplexEvent");
  ...
  public int getTokens(int addr) {
      ...
      jcas.throwFeatMissing("tokens", "uk.gov.dstl.baleen.types.semantic.ComplexEvent");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public ComplexEvent_Type(JCas jcas, Type casType) {
    super(jcas, casType);
