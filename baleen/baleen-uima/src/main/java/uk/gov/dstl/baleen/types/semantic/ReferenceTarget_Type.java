 ...
 * this reference target is valid. Updated by JCasGen Wed Feb 17 10:06:28 GMT 2016
 * 
 * @generated
 */
public class ReferenceTarget_Type extends BaleenAnnotation_Type {
	...
	private final FSGenerator fsGenerator = (addr, cas) -> {
		if (ReferenceTarget_Type.this.useExistingInstance) {
			...
			return new ReferenceTarget(addr, ReferenceTarget_Type.this);
		}
	};
	/** @generated */
	...
	public final static boolean featOkTst = JCasRegistry
			.getFeatOkTst("uk.gov.dstl.baleen.types.semantic.ReferenceTarget");
