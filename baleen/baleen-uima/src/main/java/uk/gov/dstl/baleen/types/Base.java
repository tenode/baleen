 ...
 *
 * Updated by JCasGen Wed Feb 17 10:06:28 GMT 2016
 *
 * @generated
 */
public class Base extends BaleenAnnotation {
	...
	/**
	 * getter for referent - gets Can be used to link a corefence to an entity to another
	 * (presuambly more definitive) mention of the same entity elsewhere in the text.
	 * 
	 * @generated
	 * @return value of the feature
	 */
	public ReferenceTarget getReferent() {
		...
		return (ReferenceTarget) jcasType.ll_cas
				.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((Base_Type) jcasType).casFeatCode_referent));
	}

	/**
	 * setter for referent - sets Can be used to link a corefence to an entity to another
	 * (presuambly more definitive) mention of the same entity elsewhere in the text.
	 * 
	 * @generated
	 * @param v
	...
	public void setReferent(ReferenceTarget v) {
		...
		jcasType.ll_cas.ll_setRefValue(addr, ((Base_Type) jcasType).casFeatCode_referent,
